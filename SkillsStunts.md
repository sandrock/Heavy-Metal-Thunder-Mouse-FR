...
| HMTM       | HMTM FR      |Surmonter|Créer avantage|Attaque|Défense| FATE         | FATE FR      |
|------------|--------------|---------|--------------|-------|-------|--------------|--------------|
...
| Leadership | Meneur       | oui     | oui          |       | oui   | N/A          | N/A          |
...
| Mischief   | Tricherie    | oui     | oui          |       |       | N/A          | N/A          |
...
| Fellowship | Appartenance | oui     | oui          |       |       | N/A (club)   | N/A (club)   |
| Strength   | Autonomie    | oui     | oui          | oui   | oui   | N/A (club)   | N/A (club)   |
| Order      | Ordre        | oui     | oui          | oui   | oui   | N/A (club)   | N/A (club)   |
| Resources  | Ressources   | oui     | oui          |       |       | N/A (club)   | N/A (club)   |
...
- *Brawler (core-p65)* - Bagarreur
- *Tail fighter (core-p65)* - Coup de queue
- *Born fighter (core-p140)* - Combattant né
    - utilise Combat plutôt que Empathie, pour Créer un avantage sur un opposant concernant son habileté à combattre.
- *Scrappy fighter (core-p142)* - J'ai glissé !
...
- *Shake it off (core-p66)* - En fait, c'était rien
- *Burly (core-p66)* - C'est pour s'échauffer
- *Careful (core-p66)* - Brutale délicatesse
...
- *Gearhead (core-p67)* - Savoir mécanique
...
- *Mad dash (core-p67)* - Déplacement rapide
- *Rejoiner (core-p67)* - Défense étourdissante
- *Sewer mouse (core-p67)* - Souris des tuyaux
- *Domestic Mountaineer (core-p140)* - Grimpeur domestique
...
- *Cat Hater (core-p67)* - Prendre le chat par la queue
- *Heart of Gold (core-p67)* - Encouragement caustique
- *Cat's Meow (core-p144)* - Le chant du chat
...
* *Nitro boosters (core-p70)* - Nitro dès le début !
    - Dans une compétition (fatefr-150), commencez avec 1 victoire
* *Custom tires (core-p70)* - Pneus tout-terrains
    * +2 en Pilotage sur terrain difficile
* Pneus slick
    * +2 en Pilotage sur une route en bon état
* *Oil slick (core-p70)* - Flaque d'huile
* *Spiked hubcaps (core-p70)* - Roues qui piquent
* *Reinforced frame (core-p70)* - Structure renforcée
- *Kick it into high gear (core-p140)* - Pas qu'à moitié !
...
- *Go big or go home (core-p80)* - Tout ou rien
- *Tight formation (core-p80)* - Formation serrée
- *Cheese Wheel Burnin' (core-p80)* - 
...
- *Tight ship (core-p80)* - Pas de conneries !
